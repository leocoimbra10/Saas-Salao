                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                {authMode === 'register' && activeTab === 'user' && (
                                    ...
                                    >
                                        <NeoInput
                                            label="Como gostaria de ser chamada? (opcional)"
                                            type="text"
                                            value={preferredName}
                                ...
                                <NeoButton
                                    ...
                                    variant="ghost"
                                    fullWidth
                                    className="mt-4 text-neo-text-secondary hover:text-neo-accent"
                                >
                                    Esqueceu sua senha?
                                </NeoButton>
                            </motion.div>
            ...
            {/* Test Mode Button (Development Only) */}
            {
                authMode === 'login' && (
                    ...
                    >
                        <NeoButton
                            onClick={() => {
                                loginAsTestUser(activeTab === 'admin' ? 'admin' : 'client');
                                navigate(activeTab === 'admin' ? '/admin' : '/cliente');
                            }}
                            variant="neu"
                        >
